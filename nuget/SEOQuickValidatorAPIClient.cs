...
namespace APIVerve.API.SEOQuickValidator
{
    ...
    /// <summary>
    /// Client for the SEOQuickValidator API
    /// </summary>
    public class SEOQuickValidatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        ...
        public SEOQuickValidatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SEOQuickValidatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SEOQuickValidatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SEOQuickValidatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SEOQuickValidatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(SEOQuickValidatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SEOQuickValidatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SEOQuickValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SEOQuickValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SEOQuickValidatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SEOQuickValidatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SEOQuickValidatorQueryOptions options)
        {
